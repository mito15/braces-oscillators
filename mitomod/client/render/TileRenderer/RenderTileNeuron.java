...
public class RenderTileNeuron extends TileEntitySpecialRenderer {

	public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {

		TileNeuron tile = (TileNeuron) tileEntity;

		Tessellator tessellator = Tessellator.instance;
		World world = tile.getWorldObj();

		this.bindTexture(new ResourceLocation("mitomod", "textures/blocks/oscillator72.png"));
