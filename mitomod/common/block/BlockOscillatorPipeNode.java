...
public class BlockOscillatorPipeNode extends BlockOscillatorPipe {
	...
	public BlockOscillatorPipeNode() {
		super();
		setBlockName("BlockONPipe");
	...
	public TileEntity createNewTileEntity(World world, int a) {
		...
		return new TileOscillatorPipeNode();
	}
