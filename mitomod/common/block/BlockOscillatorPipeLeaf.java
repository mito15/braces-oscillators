...
public class BlockOscillatorPipeLeaf extends BlockOscillatorPipe {
	...
	public BlockOscillatorPipeLeaf() {
		super();
		setBlockName("BlockOLPipe");
	...
	public TileEntity createNewTileEntity(World world, int a) {
		...
		return new TileOscillatorPipeLeaf();
	}
